        ...
        <CardHeader className="p-0">
            <div className="relative w-full h-[300px] flex items-center justify-center bg-blue-200 dark:bg-gray-900">
                ...
                <div className="flex items-center text-primary gap-x-4">
                    ...
                    {project.github && (
                    <Link href={project.github} className="bg-primary inline-flex items-center justify-center w-12 h-12 rounded-full z-10 scale-0 opacity-0 group-hover:scale-100 group-hover:opacity-100 transition-all duration-200">
                        <GithubIcon size={20} className="text-white"/>
                    </Link>)}
                    <Link href={`/projects/${project.slug}`} className="bg-primary inline-flex items-center justify-center w-12 h-12 rounded-full z-10 scale-0 opacity-0 group-hover:scale-100 group-hover:opacity-100 transition-all duration-200">
